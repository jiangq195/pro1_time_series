...
from Code.utils import plot_curve, data_split, isolutionforest, imf_data, data_split_LSTM, RMSE, MAPE
...
if __name__ == '__main__':
    ...
    plot_curve(Y_test_true, Y_test_prediction, rmse, mae, mape, r2, 5, 'test', 'EEMD_LSTM')
