...
if __name__ == '__main__':
    ...
    if train_mode:
        ...
        for imf in imfs:
            ...
            Y_test_true += Y2_test
            model = LSTM_Model(X2_train, Y2_train, model_name, i)
    ...
    plot_curve(Y_test_true, Y_test_prediction, rmse, mae, mape, r2, i, 'test', model_name)

    for i in range(0, len(Y_test_prediction), 50):
        plot_curve(Y_test_true[i:i + 50], Y_test_prediction[i:i + 50], rmse, mae, mape, r2, i, f'test{i}', model_name)
